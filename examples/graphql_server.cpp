...
int main() {
    ...
    std::cout << "GraphQL server running on http://localhost:8080/graphql\n";
    std::cout << "Test it with:\n";
    std::cout << "  curl -X POST -H \"Content-Type: application/json\" -d '{\"query\": \"query { hello }\", \"variables\": {\"id\": 1}}' http://localhost:8080/graphql\n";
